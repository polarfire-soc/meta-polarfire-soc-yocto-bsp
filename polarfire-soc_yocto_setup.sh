...
echo "* icicle-kit-es: Microchip Polarfire SoC Icicle Kit Engineering Sample, emmc boot."
echo "* icicle-kit-es-sd: Microchip Polarfire SoC Icicle Kit Engineering Sample, sd boot"
