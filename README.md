...
The complete User Guides for each development platform, containing board and boot instructions, are available for the following supported platforms:
  ...
  - [ICICLE-KIT-ES](https://github.com/polarfire-soc/polarfire-soc-documentation/blob/master/boards/mpfs-icicle-kit-es/icicle-kit-sw-developer-guide/icicle-kit-sw-developer-guide.md) (Icicle Kit Engineering Sample) (Requires Design Tag 2021.08 )
...
repo init -u https://github.com/polarfire-soc/meta-polarfire-soc-yocto-bsp.git -b 2021.08 -m tools/manifests/riscv-yocto.xml
```
